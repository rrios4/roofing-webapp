...
export const useDeleteInvoiceLineItem = (toast: any) => {
  const queryClient = useQueryClient();
  return useMutation((deleteLineItemObject:any) => deleteInvoiceLineItemById(deleteLineItemObject), {
    onError: (error: any) => {
      toast({
        position: 'top',
...
export const useDeleteAllInvoiceLineItemsByInvoiceNumber = (toast: any, setOpen: any) => {
  ...
  return useMutation((invoiceNumber:number) => deleteAllInvoiceLineItemsByInvoiceNumber(invoiceNumber), {
    onError: (error: any) => {
      setOpen(false);
      toast({
