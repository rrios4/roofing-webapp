          ...
          <View style={styles.table}>
            ...
            {hasLineItems ? (
              ...
              <View style={styles.tableRow}>
                <Text style={[styles.text, { flex: 3 }]}>{quote.service?.name || 'Roofing Service'}</Text>
        ...
        {quote.service?.name === 'Roof Installation' && (
          <View style={{ marginBottom: 15 }}>
            ...
            <View style={styles.infoBox}>
              ...
              <Text style={[styles.text, { fontWeight: 'bold', marginBottom: 4, color: '#374151' }]}>
              ...
              <View style={{ marginBottom: 8 }}>
                ...
                <Text style={styles.text}>• Up to 3 sheets of new plywood ($85 per extra sheet)</Text>
                <Text style={styles.text}>• Labor to install new shingles (6 nail for secure hold against storms)</Text>
                <Text style={styles.text}>• Cleaning Debris</Text>
              </View>
              <Text style={[styles.text, { fontStyle: 'italic', color: '#374151', lineHeight: 1.4 }]}>
                In order to initiate the roofing process promptly, we kindly request a down payment of 50% of 
                the total quoted amount, which will be allocated towards the procurement of necessary materials.
              </Text>
            </View>
          </View>
        )}
