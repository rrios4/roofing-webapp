...
import { Box, Button, Text, Stack, VStack, HStack, Image, StackDivider, Spinner, Tooltip, Badge, Avatar, Card, CardBody, Flex, Divider, useColorModeValue, IconButton} from '@chakra-ui/react';
            ...
            <CardBody>
                <Flex direction={'column'}>
                    ...
                    <Stack direction={'row'} mx={'auto'} my={'2rem'} gap={2}>
                        <Tooltip label={'Edit'}>
                            <IconButton _hover={{bg:'blue.400', color:'white',}} onClick={onOpen} icon={<MdEdit/>}/>
                        </Tooltip>
                        <Tooltip label={'Delete'}>
                            <IconButton _hover={{bg:'red.500', color:'white',}} onClick={deleteCustomer} icon={<MdDelete/>}/>
                        </Tooltip>
                    </Stack>  
