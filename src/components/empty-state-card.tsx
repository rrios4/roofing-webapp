...
export default function EmptyStateCard({ icon, entity, activateModal }: Props) {
  return (
    <div className="flex w-full justify-center p-8 mx-auto mt-4 max-w-[600px] shadow-sm border rounded-lg">
      <div className="flex flex-col gap-2">
          <div className='mx-auto p-3 border rounded-lg w-max'>{icon}</div>
