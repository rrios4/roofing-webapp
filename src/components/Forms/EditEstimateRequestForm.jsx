...
const EditEstimateRequestForm = (props) => {
    const { isOpen, onOpen, objectData, initialRef, handleSubmit, handleEditOnChange, handleEditCancel } = props
    ...
    return (
        <DrawerIndex initialFocusRef={initialRef} isOpen={isOpen} onClose={handleEditCancel} bg={bg} size="lg">
            ...
            <form onSubmit={handleSubmit} method='PATCH'>
                <Flex flexDir={'row'} mb={'1rem'}>
                    <Flex flexDirection={'column'} mr={'1rem'}>
                        ...
                        <Select name='est_request_status_id' value={objectData.est_request_status_id} onChange={handleEditOnChange}>
                ...
                <FormControl>
                    ...
                    <Input name='streetAddress' type={'text'} value={objectData.streetAddress} onChange={handleEditOnChange} />
                </FormControl>
                <Flex mt={'1rem'} flexDir={'row'} mb={'1rem'}>
                    <Flex flexDirection={'column'} mr={'1rem'}>
                        <FormLabel>City</FormLabel>
                        <Input name='city' type={'text'} defaultValue={objectData.city} onChange={handleEditOnChange} />
                    </Flex>
                    <Flex flexDirection={'column'}>
                        <FormLabel>State</FormLabel>
                        <Input name='state' type={'text'} value={objectData.state} onChange={handleEditOnChange} />
                    </Flex>
                    <Flex flexDirection={'column'} ml={'1rem'}>
                        <FormLabel>Post Code</FormLabel>
                        <Input name='zipcode' type={'text'} value={objectData.zipcode} onChange={handleEditOnChange} />
                    </Flex>
                </Flex>
                ...
                <Flex flexDir={'row'} mb={'1rem'}>
                    <Flex flexDirection={'column'} mr={'1rem'}>
                        ...
                        <Input name='firstName' type={'text'} value={objectData.firstName} onChange={handleEditOnChange} />
                    </Flex>
                    <Flex flexDirection={'column'} ml={'1rem'}>
                        <FormLabel>Last Name</FormLabel>
                        <Input name='lastName' type={'text'} value={objectData.lastName} onChange={handleEditOnChange} />
                    </Flex>
                </Flex>
                <FormControl>
