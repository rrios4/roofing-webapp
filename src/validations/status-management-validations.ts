...
export const statusFormSchema = z.object({
  name: z
    ...
    .regex(/^[a-zA-Z0-9\s\-_\.]+$/, 'Status name can only contain letters, numbers, spaces, hyphens, underscores, and dots')
...
export const STATUS_VALIDATION_MESSAGES = {
  name: {
    ...
    pattern: 'Status name can only contain letters, numbers, spaces, hyphens, underscores, and dots',
...
export const getStatusSuggestions = (type: 'invoice' | 'quote' | 'quote_request'): readonly string[] => {
