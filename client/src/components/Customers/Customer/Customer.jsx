    ...
    <>
        {customers ? customers.map((customer,index) => (
            <Tr key={index}>
                ...
                <Td>{customer.customer_type_id === 1 ? <><Box maxW={'100px'}><Text fontSize={'md'} textAlign={'center'} p={'2'} rounded={'full'} bg={'blue.500'} textColor={'white'} fontWeight={'light'}>Residential</Text></Box></>  : ""}
                    {customer.customer_type_id === 2 ? <><Box maxW={'100px'}><Text textAlign={'center'} p={'2'} rounded={'full'} bg={'green.500'} textColor={'white'} fontWeight={'light'}>Commercial</Text></Box></> : ""}
