    ...
    <>
        {customers ? customers.map((customer,index) => (
            <Tr key={index}>
                ...
                <Td textAlign={'center'}>{customer.customer_type_id === 1 ? <><Box maxW={'100px'}><Text fontSize={'sm'} textAlign={'center'} p={'2'} rounded={'full'} bg={'blue.500'} textColor={'white'} fontWeight={'light'}>Residential</Text></Box></>  : ""}
